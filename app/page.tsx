...
import { StartupCard } from "@/components/startup-card" // Fixed import path from camelCase to kebab-case to match actual filename

export default function Home() {
  const featuredStartups = STARTUP_DATA.filter((s) => s.verificationStatus === "verified").slice(0, 3)
